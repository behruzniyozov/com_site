...
from stories.constants import STORY_EXPIRE_HOURS
...
def story_post_save(sender, instance, created, **kwargs):
    ...
    if created:
        expire_time = instance.created_at + timedelta(STORY_EXPIRE_HOURS)
        args = [instance.id]
        ...
        task, created = PeriodicTask.objects.get_or_create(
            ...
            task="stories.tasks.create_story_expirer_task",
            clocked=clocked,
